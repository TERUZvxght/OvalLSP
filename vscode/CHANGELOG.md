...
- **A stdlib class can be answered about but not judged against — the half 0.4.0 left** `024.321`
- **The server never passes bundle_context, so gem RBS is never loaded -- while the cache fingerprint hashes the lockfile that decides it** `024.322`
