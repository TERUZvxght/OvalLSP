...
| Ruby 4.0.x | Best effort — a non-gating CI job runs the Core suite under 4.0 on every pull request and every push to `main`, and reports how many examples ran; a 4.0-only failure is recorded with a release on it rather than left open |
