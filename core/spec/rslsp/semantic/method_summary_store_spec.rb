...
RSpec.describe Rslsp::Semantic::MethodSummaryStore do
  subject(:store) { described_class.new }

  def sym(name) = Rslsp::Index::SymbolId.new(kind: :instance_method, owner: "::X", name: name, discriminator: nil)

  def summary(name, dependencies: [])
    Rslsp::Semantic::MethodSummary.new(
      symbol_id: sym(name), parameter_types: {}, return_type: Rslsp::Types::UNKNOWN, effects: [],
