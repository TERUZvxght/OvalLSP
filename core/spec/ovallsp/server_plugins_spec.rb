...
RSpec.describe "Ovallsp::Server plugin loading (Task 018)" do
  ...
  after { Ovallsp::Plugins.clear_registration("ovallsp-example-state-machine") }
  ...
  it "drops a malformed plugin declaration instead of crashing the whole Server on it" do
    ...
    context = Ovallsp::Plugins::StaticContext.new("bad-plugin").tap do |c|
