...
- Accepting responsibility for mistakes, apologizing, and learning from
  them.
...
be reported to the maintainers — see [SUPPORT.md](SUPPORT.md) for how to
reach out. All complaints will be reviewed and investigated promptly and
fairly.
...
2.1, available under its own terms for reuse by open-source projects.
