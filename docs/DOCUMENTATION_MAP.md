...
| **A known limitation** | `docs/KNOWN_LIMITATIONS.md` + `.ja.md`, and the site page that claims the opposite, if any; and a `024.*` entry's user-visible half belongs here too — see 024.25 for why nothing checks that yet | — |
