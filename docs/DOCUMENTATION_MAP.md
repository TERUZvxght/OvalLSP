...
- `site/capabilities.html` still says "Find references, rename, workspace
  symbols" unqualified; 0.1.15 narrowed that — a method a macro declared
  is refused rather than renamed — in README's `[^rename]` footnote and in
