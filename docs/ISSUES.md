...
- **2026-09-05 review R05: Dependency and RBS changes do not republish caller diagnostics**
...
**Six items above; the rest was emptied deliberately.** The twenty-one items that had
...
**50 open**, 290 resolved. 37 of the open ones are user-visible, and 38 are published in `KNOWN_LIMITATIONS` (38 in Japanese).
