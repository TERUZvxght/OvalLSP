...
**51 open**, 276 resolved. 37 of the open ones are user-visible, and 38 are published in `KNOWN_LIMITATIONS` (38 in Japanese).
...
| [`024.330`](design/tasks/024-deferred-review-findings.md#024330-every-reference-to-a-workspace-constant-that-is-not-a-class-or-module-is-reported-unresolved) | defect | no | — | Every reference to a workspace constant that is not a class or module is reported unresolved |
