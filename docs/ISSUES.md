...
**63 open**, 252 resolved. 39 of the open ones are user-visible, and 40 are published in `KNOWN_LIMITATIONS` (40 in Japanese).
...
| [`024.306`](design/tasks/024-deferred-review-findings.md#024306-the-030-record-states-as-measured-that-a-methodcall-candidate-never-resolves-to-a-constant) | defect | no | — | The 0.3.0 record states as measured that a `:method_call` candidate never resolves to a constant |
| [`024.307`](design/tasks/024-deferred-review-findings.md#024307-the-capability-suites-own-fixtures-cannot-reach-six-shapes-the-release-found) | friction | no | — | The capability suite's own fixtures cannot reach six shapes the release found |
| [`024.308`](design/tasks/024-deferred-review-findings.md#024308-referenceresolverresolve-states-no-contract-about-alignment) | friction | no | — | `ReferenceResolver#resolve` states no contract about alignment |
| [`024.309`](design/tasks/024-deferred-review-findings.md#024309-the-quick-fix-e2e-example-asserts-that-the-result-parses-which-both-answers-do) | friction | no | — | The quick-fix E2E example asserts that the result parses, which both answers do |
| [`024.310`](design/tasks/024-deferred-review-findings.md#024310-a-range-arity-reads-takes-01-argument) | defect | yes | yes | A range arity reads "takes 0..1 argument" |
| [`024.311`](design/tasks/024-deferred-review-findings.md#024311-referencecandidates-comment-omits-a-field-four-readers-use) | friction | no | — | `ReferenceCandidate`'s comment omits a field four readers use |
| [`024.312`](design/tasks/024-deferred-review-findings.md#024312-the-release-record-has-one-direction-of-the-ivar-split-and-not-the-other) | defect | no | — | The release record has one direction of the ivar split and not the other |
| [`024.313`](design/tasks/024-deferred-review-findings.md#024313-four-comment-lines-and-a-chain-sit-at-the-wrong-indentation) | friction | no | — | Four comment lines and a chain sit at the wrong indentation |
| [`024.314`](design/tasks/024-deferred-review-findings.md#024314-a-comment-numbers-a-schema-bump-that-was-not-made) | defect | no | — | A comment numbers a schema bump that was not made |
| [`024.315`](design/tasks/024-deferred-review-findings.md#024315-inlay-hints-label-block-parameters-and-no-release-note-says-so) | defect | no | — | Inlay hints label block parameters, and no release note says so |
| [`024.316`](design/tasks/024-deferred-review-findings.md#024316-two-lines-each-drop-a-top-level-call-and-only-both-together-are-pinned) | friction | no | — | Two lines each drop a top-level call, and only both together are pinned |
| [`024.317`](design/tasks/024-deferred-review-findings.md#024317-six-of-the-documentation-maps-trigger-rows-have-nothing-enforcing-them) | friction | no | — | Six of the documentation map's trigger rows have nothing enforcing them |
