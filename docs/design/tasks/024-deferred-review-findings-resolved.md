...
**Area:** `docs/PUBLISHING.md`, `docs/PUBLISHING.ja.md` <!-- deleted -->
...
**Area:** `scripts/preflight.rb`, `CONTRIBUTING.md` + `.ja.md` <!-- deleted -->
...
*057 retired both specs and the markers they read. What relates the card
to the documents behind it now is a declaration in each document of the
card section it stands behind, held to existing by
`core/spec/meta/agents_card_spec.rb`.*
...
`CONTRIBUTING.md`, `CONTRIBUTING.ja.md` and `preflight.rb`'s header all <!-- deleted -->
...
ci: cannot tell -- `gh` is not installed (see CONTRIBUTING.md) <!-- deleted -->
```
